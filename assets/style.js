const styleText0 = `
[data-v-5736b41d] .menu-tree .ant-tree-node-content-wrapper{
  display:flex;
  align-items:center;
}
[data-v-5736b41d] .menu-tree .ant-tree-node-content-wrapper .ant-tree-iconEle{
  margin-right:0.5rem;
  height:1rem;
  width:1rem;
}
[data-v-5736b41d] .menu-tree.ant-tree.ant-tree-directory .ant-tree-treenode-selected:hover::before,[data-v-5736b41d] .menu-tree.ant-tree.ant-tree-directory .ant-tree-treenode-selected::before{
  background:#e5e7eb;
}
[data-v-5736b41d] .menu-tree.ant-tree.ant-tree-directory .ant-tree-treenode .ant-tree-node-content-wrapper.ant-tree-node-selected{
  color:#1890ff;
}
