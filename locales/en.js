export default {
  ...
  variable_desc_placeholder: 'Variable Description, (max length: 400)',
  variable_name_placeholder: 'Variable Name, (max length: 100)',
  variable_value_placeholder: 'Variable Value, (max length: 100)',
  ...
  generate_token: 'Token generation (OAuth2 flow)',
  ...
  code_verifier: 'Verification Code',
  scope: 'Scope',
  authorization_code: 'Authorization Code Flow',
  password_credentials: 'Password Grant（Password Credentials）',
  ...
  license_name_placeholder: 'License Name, (max length: 200)',
